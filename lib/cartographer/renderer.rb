...
module Cartographer
  # Draws the crawled tree of URLs and assets, generated by `Cartographer::Crawler`.
  #
  # == Output
  #
  #   └── <url> [assets]
  ...
  #
  #   root
  #   # => #<Cartographer::Page url="http://example.com"/>
  #
  #   root.children
  #   # => [#<Cartographer::Page url="http://example.com/foo"/>, #<Cartographer::Page url="http://example.com"/bar>]
  #
  #   renderer = Cartographer::Renderer.new(root)
  #   renderer.draw
  #
  ...
  class Renderer
    ...
    # == Parameters
    #
    #   [Cartographer::Page] page The page to render
